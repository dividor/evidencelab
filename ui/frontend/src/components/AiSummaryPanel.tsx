  ...
  const handleGenerateGlobalSummary = useCallback(async () => {
    ...
    try {
      ...
      const summaryContext = summaries
        ...
        .join('\n');
      const query = `Synthesise a comprehensive global summary from the following research topics, in the context of: "${rootLabel}". Use the search results below to cite sources.\n\nResearch summaries so far:\n${summaryContext}`;
