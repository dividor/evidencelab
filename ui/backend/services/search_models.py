...
SEARCH_EXACT = os.getenv("SEARCH_EXACT", str(search_config.get("exact", False))).lower() in ("1", "true", "yes")
QUANTIZATION_RESCORE = os.getenv("QUANTIZATION_RESCORE", str(search_config.get("quantization_rescore", True))).lower() in ("1", "true", "yes")
