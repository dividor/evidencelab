...
- **Privacy policy placeholders:** `docs/overview/privacy.md` names the data controller and hosting region as bracketed placeholders; fill them in for your deployment before publishing.
